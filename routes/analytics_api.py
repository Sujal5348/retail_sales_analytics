...
SELECT 
    ...
    CASE 
        WHEN SUM(od.Quantity * od.UnitPrice * (1 - od.Discount/100)) >= 15000 THEN 'VIP (₹15,000+)'
        WHEN SUM(od.Quantity * od.UnitPrice * (1 - od.Discount/100)) >= 5000 THEN 'High Value (₹5,000+)'
        WHEN SUM(od.Quantity * od.UnitPrice * (1 - od.Discount/100)) >= 1500 THEN 'Mid Tier (₹1,500+)'
        ELSE 'Low Tier'
    END AS Tier
FROM Customers c
